...
export const groupsFields: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'Enter participant numbers separated by comma (e.g., 5511999999999,5511888888888)',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['create-group'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'URL of the image that will be set as group picture',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['update-group-picture'],
	...
	},
	{
		...
		required: true,
		description: 'Message that will be sent with the invite link',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['send-invite-link'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'Enter recipient numbers separated by comma (e.g., 5511999999999,5511888888888)',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['send-invite-link'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'ID of the group to fetch information',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['fetch-groups'],
	...
	},
	{
		...
		default: 'add',
		required: true,
		description: 'Action to be executed with members',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['update-participants'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'List of member numbers separated by comma (e.g., 5511999999999,5511888888888)',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['update-participants'],
